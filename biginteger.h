...
////    std::cin >> a;
////    std::cout << a;
////    assert(std::to_string(--aa) == (--a).toString());
////    BigInteger a = "44699337153065371829673888612508530353263569192807880435012851273971849772817";
////    BigInteger b = "746733634224663495241174049998953876292830825534635840012988899289555339072985";
////    std::cout << (a <= b);
//    return 0;
//}